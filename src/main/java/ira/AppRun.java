...
public class AppRun {
    public static void main(String[] args) {
        ...
        SomeItem someItem = new SomeItem("Balalayka", 10, 2, 1, 3, 4, 5, EnumTypeItem.ARMOR, EnumItemStatus.WITHOUT_STATUS);
        ...
        SomeItem someItem5 = new SomeItem("Ai", 230, 2, 1, 3, 4, 5, EnumTypeItem.WEAPON, EnumItemStatus.WITHOUT_STATUS);
